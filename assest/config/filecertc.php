...
if ($use_auth) {
    if (isset($_SESSION['logged'], $auth_users[$_SESSION['logged']])) {
        ...
        ?>
        <div class="path">
            <form class="form-one-line" data-form-layout="oneline-1" action="" method="post" style="margin:10px;text-align:center">
...
if (isset($_GET['upload'])) {
    ...
    <div class="path">
        ...
        <form class="form-one-line" data-form-layout="oneline-2" style="display:flex;flex-wrap:wrap;align-items:flex-end;gap:0.65rem;padding:0.65rem 0;border-bottom:1px solid #3a3a3a;" action="" method="post" enctype="multipart/form-data">
...
if (isset($_POST['copy'])) {
    ...
    <div class="path">
        <p><b>Copying</b></p>
        <form class="form-one-line" data-form-layout="oneline-3" style="display:flex;flex-wrap:wrap;align-items:flex-end;gap:0.65rem;padding:0.65rem 0;border-bottom:1px solid #3a3a3a;" action="" method="post">
            <input type="hidden" name="p" value="<?php echo fm_enc(FM_PATH) ?>">
...
if (isset($_GET['chmod']) && !FM_IS_WIN) {
    ...
    <div class="path">
        ...
        <form class="form-one-line" data-form-layout="oneline-4" style="display:flex;flex-wrap:wrap;align-items:flex-end;gap:0.65rem;padding:0.65rem 0;border-bottom:1px solid #3a3a3a;" action="" method="post">
            <input type="hidden" name="p" value="<?php echo fm_enc(FM_PATH) ?>">
...
$all_files_size = 0;
?>
<form class="form-one-line" data-form-layout="oneline-5" style="display:flex;flex-wrap:wrap;align-items:flex-end;gap:0.65rem;padding:0.65rem 0;border-bottom:1px solid #3a3a3a;" action="" method="post">
<input type="hidden" name="p" value="<?php echo fm_enc(FM_PATH) ?>">
