          ...
          <li class="treeview">
            ...
            <ul class="treeview-menu">              
                <?php if($PFCFRECHAZO=="1"){ ?>
                  ...
                  <li><a href="registroInspectionMP.php">Inspección MP<i class="ti-more"></i></a></li>
                  <li><a href="registroInspectionDestino.php">Inspección en Destino<i class="ti-more"></i></a></li>
                  <li><a href="listarInspectionDestino.php">Agrupado Inspección Destino<i class="ti-more"></i></a></li>
