  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <?php if($PESTADISTICA=="1"){ ?>
        ...
        <?php if($PESTAINFORME=="1" || $PESTAPRODUCTOR=="1"){ ?>
          <li class="treeview">
            <a href="#">
            ...
            <ul class="treeview-menu">
              <?php if($PESTAPRODUCTOR=="1"){ ?>
                ...
                <li><a href="listarProductorProceso.php">Proceso Productor</i></a></li>
              <?php  } ?>
        ...
        <?php  } ?>
        <?php if($PESTAINFORME=="1" || $PESTADISTICA=="1"){ ?>
          <li class="treeview">
            <a href="#">
        ...
        <?php  } ?>
        <?php if($PESTAEXISTENCIA=="1" || $PESTADISTICA=="1"){ ?>
          <li class="treeview">
            <a href="#">
