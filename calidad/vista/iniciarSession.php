...
<head>
    <meta charset="UTF-8">
    <title>Acceso Calidad - SmartBerry ONE</title>
...
<main class="page">
    <section class="left-panel">
        <div class="left-content">
            <header class="brand">
                ...
                <h1 class="title">Acceso a control de calidad SmartBerry ONE</h1>
                <p class="subtitle">Ingresa para gestionar controles, rechazos, levantamientos e inspecciones.</p>
            ...
            <div class="footer-text">SmartBerry ONE · Portal privado de calidad.</div>
        </div>
    </section>
    <section class="right-panel">
        ...
        <div class="right-info"><div class="right-kicker"><span class="material-icons-round">verified</span>Control de calidad</div><h2>Calidad conectada con la operación</h2><p>Revisa y registra información de calidad desde una vista segura y ordenada.</p><div class="right-tags"><div class="right-tag"><span class="material-icons-round">eco</span>Producción</div><div class="right-tag"><span class="material-icons-round">qr_code_scanner</span>Trazabilidad</div><div class="right-tag"><span class="material-icons-round">shield</span>Control</div></div></div>
    </section>
</main>
<script>
