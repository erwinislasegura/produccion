...
<main class="page">
    <section class="left-panel">
        <div class="left-content">
            <header class="brand">
                ...
                <div class="module-badge"><span class="material-icons-round">verified</span>Módulo calidad</div>
    ...
    <section class="right-panel">
        ...
        <div class="right-info"><div class="right-kicker"><span class="material-icons-round">tune</span>Parámetros</div><h2>Continúa con empresa, planta y temporada</h2><p>Selecciona el contexto para revisar y gestionar controles de calidad.</p><div class="right-tags"><div class="right-tag"><span class="material-icons-round">business</span>Empresa</div><div class="right-tag"><span class="material-icons-round">factory</span>Planta</div><div class="right-tag"><span class="material-icons-round">event</span>Temporada</div></div></div>
    </section>
</main>
<script>
