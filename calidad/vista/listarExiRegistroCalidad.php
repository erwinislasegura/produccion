...
<head>
    ...
    <!- LLAMADA DE LOS ARCHIVOS NECESARIOS PARA DISEÑO Y FUNCIONES BASE DE LA VISTA -!>
        ...
        <style>
            ...
            .quality-panel { border:1px solid #d8e1ec; border-radius:10px; box-shadow:0 2px 8px rgba(17,32,51,.04); overflow:hidden; background:#fff; }
            .quality-panel .box-header, .quality-register-panel__header { background:#eff3f8; border-bottom:1px solid #dbe3ee; padding:10px 14px; }
            .quality-panel .box-title, .quality-register-panel__title { color:#2d4057; font-size:14px; font-weight:600; margin:0; }
            .quality-panel .box-body { padding:12px 14px; }
            .quality-table { width:100%; }
            .quality-table thead th { background:#f4f7fc; color:#4d5d79 !important; border-bottom:1px solid #e2e9f5; font-size:12px; text-transform:uppercase; letter-spacing:.03em; vertical-align:middle; }
            .quality-table tbody td { color:#22314a !important; border-top:1px solid #e8edf6; vertical-align:middle; }
            .quality-register-panel { margin:0 15px 18px; border:1px solid #d8e1ec; border-radius:10px; box-shadow:0 2px 8px rgba(17,32,51,.04); background:#fff; overflow:hidden; }
            .quality-register-panel__body { padding:14px; }
            .quality-register-panel__footer { background:#f7f9fc; border-top:1px solid #e1e8f2; padding:10px 14px; text-align:right; }
            .quality-register-form { border-bottom:1px solid #e1e8f2 !important; padding:0 0 12px !important; }
            .quality-register-form .form-control { border-radius:6px; font-size:12px; }
            .quality-register-history { max-height:300px; overflow:auto; border:1px solid #e5ebf3; border-radius:8px; }
        </style>
        <!- FUNCIONES BASES -!>
...
<body class="hold-transition light-skin fixed sidebar-mini theme-primary sistemRR" >
    <div class="wrapper">
        <!- LLAMADA AL MENU PRINCIPAL DE LA PAGINA-!>
            ...
            <div class="content-wrapper">
                <div class="container-full">
                    ...
                    <section class="content">
                        <div class="box quality-panel">
                            <div class="box-header with-border"><h4 class="box-title">Folios disponibles para registro</h4></div>
                            <div class="box-body">
                                <div class="row">
                                    <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 col-xs-12">
                                        <div class="table-responsive">
                                            <table id="tabla-registro-calidad" class="table table-hover quality-table">
                                                <thead>
                                                    ...
                                                    <?php foreach ($ARRAYEXIEXPORTACION as $r) : ?>
                                                          ...
                                                          <?php 
                                                            ...
                                                            <td>                                                                   
                                                                ...
                                                                <td>
                                                                <button type="button" class="btn btn-info btn-rounded registroCalidad" attr-id="<?php echo $r['FOLIO_AUXILIAR_EXIEXPORTACION']; ?>" attr-idex="<?php echo $r['FOLIO_EXIEXPORTACION']; ?>">
					                                                Añadir Registro
				                                                </button>
                                                                </td>
            ...
            <!-- Panel inline de registro de calidad -->
  <div class="quality-register-panel d-none" id="modal-left">
          <div class="quality-register-panel__header d-flex justify-content-between align-items-center">
            <h5 class="quality-register-panel__title">Registro de Calidad</h5>
            <button type="button" class="close btnCerrarRegistro" aria-label="Cerrar">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
          <div class="quality-register-panel__body">
            <form data-form-layout="oneline-1" style="display:flex;flex-wrap:wrap;align-items:flex-end;gap:0.65rem;padding:0.65rem 0;border-bottom:1px solid #3a3a3a;" class="form formRegistroCalidad form-one-line quality-register-form" id="formRegistroCalidad">
            <div class="box-body">
                <div class="row">
                    <div class="col-md-4">
            ...
            <div class="row quality-register-history">
                <div class="col-md-12">
                    <div class="table-responsive">
          ...
          <div class="quality-register-panel__footer">
            <button type="button" class="btn btn-rounded btn-secondary btnCerrarRegistro">Cerrar</button>
          </div>
    </div>
  <!-- /.panel inline -->
                        <!-- /.box -->
    ...
    buttons: [
        ...
        <script>
            ...
            $('body').on('click', '.btnCerrarRegistro', function(event) {
                event.preventDefault();
                $('#modal-left').addClass('d-none');
            });
        ...
        $('input[name="action"]').val('insert');
                ...
                $("#modal-left").removeClass("d-none");
                if ($("#modal-left").offset()) {
                    $('html, body').animate({ scrollTop: $("#modal-left").offset().top - 80 }, 300);
                }
                return false;
            });
