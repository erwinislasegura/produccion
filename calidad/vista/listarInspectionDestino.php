...
$INSPECTION_PT_CONTROLLER = new InspectionDestinationController();
$USUARIO_ADO = new USUARIO_ADO();

$ARRAYINSPECTIONDESTINO = [];
$MENSAJE = "";
$MENSAJEENVIO = "";
...
if ($_POST) {
    ...
    $datosInspeccion = $IDINSPECCION > 0 ? $INSPECTION_PT_CONTROLLER->getInspectionSummaryById($IDINSPECCION) : null;
    ...
    if (!$datosInspeccion && $IDINSPECCION > 0) {
        ...
        if (isset($_REQUEST['SOLICITAR_CERRAR'])) {
            ...
            $asunto = 'Autorización cierre inspección en destino #' . $datosInspeccion['inspection_number'];
            $mensajeCorreo = "Se solicitó cerrar/eliminar una inspección en destino.\r\n\r\n" .
                "N° inspección: " . $datosInspeccion['inspection_number'] . "\r\n" .
                "N° contenedor: " . $datosInspeccion['reception_number'] . "\r\n" .
        ...
        if (isset($_REQUEST['CONFIRMAR_CERRAR'])) {
            ...
            if (!$codigoSesion || !$idSesion || (int)$idSesion !== $IDINSPECCION) {
                ...
                $INSPECTION_PT_CONTROLLER->deleteInspection($IDINSPECCION, $IDUSUARIOS);
        ...
        if (isset($_REQUEST['SOLICITAR_ABRIR'])) {
            ...
            $asunto = 'Autorización apertura inspección en destino #' . $datosInspeccion['inspection_number'];
            $mensajeCorreo = "Se solicitó abrir una inspección en destino.\r\n\r\n" .
                "N° inspección: " . $datosInspeccion['inspection_number'] . "\r\n" .
                "N° contenedor: " . $datosInspeccion['reception_number'] . "\r\n" .
                "Fecha inspección: " . $datosInspeccion['inspection_date'] . "\r\n" .
                "Productor: " . $datosInspeccion['producer_name'] . "\r\n" .
        ...
        if (isset($_REQUEST['CONFIRMAR_ABRIR'])) {
            ...
            if (!$codigoSesion || !$idSesion || (int)$idSesion !== $IDINSPECCION) {
                ...
                $INSPECTION_PT_CONTROLLER->updateInspectionState($IDINSPECCION, 1, $IDUSUARIOS);
...
if ($EMPRESAS && $PLANTAS && $TEMPORADAS) {
    $ARRAYINSPECTIONDESTINO = $INSPECTION_PT_CONTROLLER->getInspectionGrouped($EMPRESAS, $PLANTAS, $TEMPORADAS);
}
?>
<!DOCTYPE html>
<html lang="es">
<head>
    <title>Agrupado Destino</title>
                            ...
                            <div class="d-inline-block align-items-center">
                                <nav>
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page"><a href="#">Agrupado Destino</a></li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <section class="content">
                    ...
                    <div class="box">
                        <div class="box-header with-border">
                            <h4 class="box-title">Agrupado Destino</h4>
                        </div>
                        <div class="box-body">
                            <div class="table-responsive">
                                <table id="agrupadoinspectionmp" class="table table-hover" style="width:100%;">
                                    ...
                                    <tbody>
                                        <?php foreach ($ARRAYINSPECTIONDESTINO as $r) : ?>
                                                    ...
                                                    <div class="list-icons d-inline-flex">
                                                        <div class="list-icons-item dropdown">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                <?php if ($estaAbierta) : ?>
                                                                    <a class="dropdown-item" href="../../calidad/inspection-destination/index.php?inspection_id=<?php echo (int)$r['id']; ?>">
                                                                ...
                                                                <?php endif; ?>
                                                                <button type="button" class="dropdown-item" onclick="abrirPestana('../../calidad/inspection-destination/export.php?id=<?php echo (int)$r['id']; ?>')">
