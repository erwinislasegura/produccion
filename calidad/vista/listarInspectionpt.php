...
$INSPECTION_PT_CONTROLLER = new InspectionPTController();
...
if ($_POST) {
    ...
    if (!$datosInspeccion && $IDINSPECCION > 0) {
        ...
        if (isset($_REQUEST['SOLICITAR_CERRAR'])) {
            ...
            $asunto = 'Autorización cierre inspección PT #' . $datosInspeccion['inspection_number'];
            $mensajeCorreo = "Se solicitó cerrar/eliminar una inspección PT.\r\n\r\n" .
                "N° inspección: " . $datosInspeccion['inspection_number'] . "\r\n" .
                "N° proceso: " . $datosInspeccion['reception_number'] . "\r\n" .
        ...
        if (isset($_REQUEST['SOLICITAR_ABRIR'])) {
            ...
            $asunto = 'Autorización apertura inspección PT #' . $datosInspeccion['inspection_number'];
            $mensajeCorreo = "Se solicitó abrir una inspección PT.\r\n\r\n" .
                "N° inspección: " . $datosInspeccion['inspection_number'] . "\r\n" .
                "N° proceso: " . $datosInspeccion['reception_number'] . "\r\n" .
                "Fecha inspección: " . $datosInspeccion['inspection_date'] . "\r\n" .
                "Productor: " . $datosInspeccion['producer_name'] . "\r\n" .
...
if ($EMPRESAS && $PLANTAS && $TEMPORADAS) {
    $ARRAYINSPECTIONPT = $INSPECTION_PT_CONTROLLER->getInspectionGrouped($EMPRESAS, $PLANTAS, $TEMPORADAS);
}
?>
<!DOCTYPE html>
<html lang="es">
<head>
    <title>Agrupado PT</title>
                            ...
                            <div class="d-inline-block align-items-center">
                                <nav>
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page"><a href="#">Agrupado PT</a></li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <section class="content">
                    ...
                    <div class="box">
                        <div class="box-header with-border">
                            <h4 class="box-title">Agrupado PT</h4>
                        </div>
                        <div class="box-body">
                            <div class="table-responsive">
                                <table id="agrupadoinspectionmp" class="table table-hover" style="width:100%;">
                                    ...
                                    <tbody>
                                        <?php foreach ($ARRAYINSPECTIONPT as $r) : ?>
                                                    ...
                                                    <div class="list-icons d-inline-flex">
                                                        <div class="list-icons-item dropdown">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                <?php if ($estaAbierta) : ?>
                                                                    <a class="dropdown-item" href="../../calidad/inspection-pt/index.php?inspection_id=<?php echo (int)$r['id']; ?>">
                                                                ...
                                                                <?php endif; ?>
                                                                <button type="button" class="dropdown-item" onclick="abrirPestana('../../calidad/inspection-pt/export.php?id=<?php echo (int)$r['id']; ?>')">
