...
if (isset($id_dato) && isset($accion_dato)) {
    ...
    if ($OP == "editar") {
        ...
        //CARGAR MERCADOS ASOCIADOS PARA PRESELECCIONARLOS EN LA EDICION
        $ARRAYREEXPORTACIONMERCADO = $REEXPORTACIONMERCADO_ADO->buscarPorEstandar($IDOP);
        foreach ($ARRAYREEXPORTACIONMERCADO as $r2) :
            $MERCADOS[] = "" . $r2['ID_MERCADO'];
        endforeach;
...
<body class="exportadora-form-compact hold-transition light-skin  sidebar-mini theme-primary sistemRR" >
    <div class="wrapper">
