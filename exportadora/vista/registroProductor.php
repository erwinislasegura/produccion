...
if (isset($id_dato) && isset($accion_dato)) {
    ...
    if ($OP == "0") {
        ...
        $ARRAYRVESPECIESPRODUCTOR = $RVESPECIES_ADO->buscarPorProductor($IDOP);
        foreach ($ARRAYRVESPECIESPRODUCTOR as $r3) :
            $VARIEDADES[] = "" . $r3['ID_VESPECIES'];
        endforeach;
...
if($_POST){
    ...
    if (isset($_REQUEST['VARIEDADES']) && is_array($_REQUEST['VARIEDADES'])) {
        $VARIEDADES = $_REQUEST['VARIEDADES'];
    }
}
        ...
        <!- FUNCIONES BASES -!>
            <script type="text/javascript">
                ...
                function validacion() {
                    ...
                    VARIEDADES = document.getElementById("VARIEDADES").selectedOptions.length;
                    ...
                    document.getElementById('val_variedades').innerHTML = "";
...
*/
                    ...
                    */
                    ...
                    if (VARIEDADES == null || VARIEDADES == 0) {
                        document.form_reg_dato.VARIEDADES.focus();
                        document.form_reg_dato.VARIEDADES.style.borderColor = "#FF0000";
                        document.getElementById('val_variedades').innerHTML = "NO HA SELECCIONADO NINGUNA VARIEDAD";
                        return false;
                    }
                    document.form_reg_dato.VARIEDADES.style.borderColor = "#4AF575";
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 col-xs-12">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control select2" id="VARIEDADES" name="VARIEDADES[]" style="width: 100%;" multiple="multiple" <?php echo $DISABLED; ?>>
                                                            <?php foreach ($ARRAYVESPECIES as $r) : ?>
                                                                <?php if ($ARRAYVESPECIES) {    ?>
                                                                    <option value="<?php echo $r['ID_VESPECIES']; ?>" <?php if (in_array($r['ID_VESPECIES'], $VARIEDADES)) { echo "selected";  } ?>>
                                                        ...
                                                        <label id="val_variedades" class="validacion"> </label>
                                                    </div>
                                                </div>
                                                <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-9 col-9 col-xs-9">
                                                    <div class="form-group">
    ...
    <!- LLAMADA URL DE ARCHIVOS DE DISEÑO Y JQUERY E OTROS -!>
        ...
        <?php 
            ...
            if (isset($_REQUEST['GUARDAR'])) {
                ...
                $RVESPECIES_ADO->guardarVariedadesPorProductor($_REQUEST['EMPRESA'], $IDPRODUCTOR, $VARIEDADES, $IDUSUARIOS);
            ...
            if (isset($_REQUEST['EDITAR'])) {
                ...
                $RVESPECIES_ADO->guardarVariedadesPorProductor($_REQUEST['EMPRESA'], $_REQUEST['ID'], $VARIEDADES, $IDUSUARIOS);
