...
<head>
    <meta charset="UTF-8">
    <title>Acceso Fruta - SmartBerry ONE</title>
...
<main class="page">
    <section class="left-panel">
        <div class="left-content">
            <header class="brand">
                ...
                <h1 class="title">Acceso a gestión de fruta SmartBerry ONE</h1>
                <p class="subtitle">Ingresa para controlar procesos, trazabilidad y operación interna de fruta.</p>
            ...
            <?php if (($_SESSION['login_attempts'] ?? 0) > 0): ?>
                <div class="login-alert">Intentos fallidos: <?= e($_SESSION['login_attempts']) ?>/5</div>
                <?php endif; ?>
            <section class="login-card">
                ...
                <form method="post" id="loginForm" autocomplete="on">
                    ...
                    <div class="form-grid">
                        ...
                        <div class="option-box"><input type="checkbox" id="PRECARGA_EXPORTACION_FRUTA"><label for="PRECARGA_EXPORTACION_FRUTA">Cargar información pesada en segundo plano.</label></div>
                        <div class="security-note"><span class="material-icons-round">lock</span>Acceso privado para usuarios autorizados</div>
                        <div class="btn-row"><a href="../../estadistica/vista/iniciarSession.php" class="btn btn-back">Portal Productores</a><button type="submit" class="btn btn-login" name="ENTRAR">Entrar</button></div>
                    </div>
                </form>
            </section>
            <div class="footer-text">SmartBerry ONE · Portal privado de fruta.</div>
        </div>
    </section>
    <section class="right-panel">
        ...
        <div class="right-info"><div class="right-kicker"><span class="material-icons-round">local_florist</span>Gestión de fruta</div><h2>Control operacional para fruta</h2><p>Accede a procesos, recepción, despacho y trazabilidad desde una vista ordenada y segura.</p><div class="right-tags"><div class="right-tag"><span class="material-icons-round">eco</span>Producción</div><div class="right-tag"><span class="material-icons-round">qr_code_scanner</span>Trazabilidad</div><div class="right-tag"><span class="material-icons-round">shield</span>Control</div></div></div>
    </section>
</main>
<script>
    ...
    if (loginForm) { loginForm.addEventListener('submit', () => { const precarga = document.getElementById('PRECARGA_EXPORTACION_FRUTA')?.checked; if (precarga) { localStorage.setItem('prefetch_despachoex_exportacion', '1'); } else { localStorage.removeItem('prefetch_despachoex_exportacion'); } }); }
</script>
<?php
