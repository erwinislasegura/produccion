	  ...
	  <div class="modal-dialog" style="width: 50%!important;">
		<div class="modal-content">
		  ...
		  <div class="modal-body">
            <form data-form-layout="oneline-1" style="display:flex;flex-wrap:wrap;align-items:flex-end;gap:0.65rem;padding:0.65rem 0;border-bottom:1px solid #3a3a3a;" class="form formRegistroCalidad form-one-line" id="formRegistroCalidad">
            <div class="box-body">
                <div class="row">
                    <div class="col-md-4">
