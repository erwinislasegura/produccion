...
<head>
    ...
    <!- LLAMADA DE LOS ARCHIVOS NECESARIOS PARA DISEÑO Y FUNCIONES BASE DE LA VISTA -!>
        ...
        <style>
            ...
            .sistemRR #recepcionmp tbody td {
                font-size: 12px;
                vertical-align: middle;
            }

            .sistemRR #recepcionmp .btn {
            ...
            .sistemRR .dropdown-menu {
                border-radius: 8px;
                border: 1px solid var(--line);
                padding: 8px;
            }

            .sistemRR .dropdown-menu .dropdown-item {
                padding: 4px 0;
            }

            .sistemRR .dropdown-menu .btn-block {
                width: 100%;
            }
            ...
            .sistemRR .box-footer .form-row {
                display: flex;
                flex-wrap: wrap;
                gap: 10px;
            }

            .sistemRR .box-footer .input-group-text {
                border-radius: 4px 0 0 4px;
                font-size: 12px;
            }

            .sistemRR .box-footer .btn.btn-default {
            ...
            .sistemRR div.dataTables_scrollBody {
                min-height: 260px;
            }
        </style>
        <!- FUNCIONES BASES -!>
