                ...
                <div class="container-full">
                    ...
                    <section class="content">
                        <div class="card">   
                            ...
                            <form data-form-layout="oneline-1" style="display:flex;flex-wrap:wrap;align-items:flex-end;gap:0.65rem;padding:0.65rem 0;border-bottom:1px solid #3a3a3a;" method="post" class="form  form-one-line" role="form" name="form_reg_dato" id="form_reg_dato"> 
                                <div class="card-body">                                    
                                    <div class="row">
                        ...
                        <?php if (isset($_GET['op'])): ?>
                            <div class="card">                            
                                ...
                                <div class="card-body">
                                    ...
                                    <form class="form-one-line" data-form-layout="oneline-4" style="display:flex;flex-wrap:wrap;align-items:flex-end;gap:0.65rem;padding:0.65rem 0;border-bottom:1px solid #3a3a3a;" method="post" id="form">
