...
¨*/
    ...
    <style>
        ...
        .sistemRR .box-body { padding:8px; background:#fafbfd; counter-reset: despacho-section; }
        ...
        .sistemRR .compact-section-title::before { counter-increment: despacho-section; content:counter(despacho-section); display:inline-flex; align-items:center; justify-content:center; width:21px; height:21px; flex:0 0 21px; border-radius:50%; background:#eaf7ee; color:var(--primary-dark); font-size:12px; font-weight:700; }
        ...
        .sistemRR .form-control:focus, .sistemRR .select2-container--default.select2-container--focus .select2-selection--single { border-color:var(--input-focus); box-shadow:0 0 0 3px rgba(40,167,69,.12); }
        ...
        .sistemRR .btn { border-radius:4px !important; min-height:34px; padding:0 14px; font-size:12px; font-weight:700; }
        .sistemRR .btn-primary, .sistemRR .btn-success { background:var(--primary); border-color:var(--primary); }
        .sistemRR .btn-primary:hover, .sistemRR .btn-success:hover { background:var(--primary-dark); border-color:var(--primary-dark); }
        ...
        .sistemRR .text-muted { display:flex; align-items:center; gap:6px; margin:0 0 6px; color:#4b5563 !important; font-size:12px; font-weight:600; }
        ...
        .sistemRR .box-footer .btn-toolbar { width:100%; }
        .sistemRR .box-footer .btn-group { display:flex; flex-wrap:wrap; gap:6px; padding-left:0; padding-right:0; }
        ...
        .sistemRR .detalle-card .card-header.bg-info, .sistemRR .detalle-card .card-header.bg-success { background:#fff !important; color:var(--text); padding:8px 12px; border-bottom:1px solid var(--line); border-top:3px solid var(--primary); }
        .sistemRR .detalle-card .card-title { margin:0; font-size:16px; font-weight:700; color:var(--text); }
        .sistemRR .detalle-card .card-header:not(.bg-info):not(.bg-success) { padding:8px 10px; background:#fafbfd; border-bottom:1px solid var(--line); }
        .sistemRR .detalle-card .card-body { padding:8px; background:#fff; }
        .sistemRR .detalle-card .form-row { gap:8px; }
        .sistemRR .detalle-card .btn { min-height:29px; height:29px; padding:0 10px; font-size:11px; white-space:nowrap; }
        .sistemRR .input-group { margin-bottom:0 !important; }
        .sistemRR .input-group-prepend .input-group-text { min-height:29px; padding:4px 8px; font-size:12px; font-weight:700; color:#374151; background:#f8fafc; border-color:var(--input-border); }
        ...
        @media (max-width:768px) {
            .sistemRR .compact-section-title { align-items:flex-start; flex-wrap:wrap; }
            .sistemRR .compact-section-title .title-sub { white-space:normal; }
            .sistemRR .box-footer, .sistemRR .btn-toolbar, .sistemRR .btn-group { display:block; width:100%; }
            .sistemRR .btn-group .btn { width:100%; margin-bottom:6px; }
        }
    </style>
                        ...
                        <form data-form-layout="oneline-1" style="display:flex;flex-wrap:wrap;align-items:flex-end;gap:0.65rem;padding:0.65rem 0;border-bottom:1px solid #3a3a3a;" class="form form-one-line" role="form" method="post" name="form_reg_dato" id="form_reg_dato">
                            <div class="box">
                                 <div class="box-header with-border bg-primary">
                                    ...
                                    <p class="box-subtitle">Complete los datos del despacho de materia prima, transporte, destino y documento de envases.</p>
                                </div>
                                <div class="box-body ">
                                    <div class="vextra-section">
                                        <div class="compact-section-title"><span class="title-main">Datos del documento</span><span class="title-sub">Número, fechas y trazabilidad</span></div>
                                    <div class="row">
                                    ...
                                    <div class="vextra-section">
                                        <div class="compact-section-title"><span class="title-main">Despacho y transporte</span><span class="title-sub">Tipo, guía, transportista y destino</span></div>
                                    <div class="row">
                                    ...
                                    <div class="vextra-section">
                                        <div class="compact-section-title"><span class="title-main">Despacho de envases</span><span class="title-sub">Documento y bodega asociada</span></div>
                                    ...
                                    <div class="vextra-section">
                                        <div class="compact-section-title"><span class="title-main">Observaciones</span><span class="title-sub">Notas adicionales del registro</span></div>
                                    <div class="row">
                                        <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" rows="1"  placeholder="Ingrese nota, observaciones u otro" id="OBSERVACIONDESPACHO" name="OBSERVACIONDESPACHO" <?php echo $DISABLED2; ?>><?php echo $OBSERVACIONDESPACHO; ?></textarea>
                            ...
                            <div class="card detalle-card">
                                ...
                                <div class="card-header">
                                    <div class="form-row align-items-center">
                                        ...
                                        <form class="form-one-line" data-form-layout="oneline-3" style="display:flex;flex-wrap:wrap;align-items:flex-end;gap:0.65rem;padding:0.65rem 0;border-bottom:1px solid #3a3a3a;" method="post" id="form2" name="form2">
                                            <input type="hidden" class="form-control" placeholder="ID DESPACHO" id="IDP" name="IDP" value="<?php echo $IDOP; ?>" />
                                            <input type="hidden" class="form-control" placeholder="OP DESPACHO" id="OPP" name="OPP" value="<?php echo $OP; ?>" />
                                            <input type="hidden" class="form-control" placeholder="URL DESPACHO" id="URLP" name="URLP" value="registroDespachomp" />
                                                            ...
                                                            <?php if ($ARRAYTOMADO) { ?>
                                                                <?php foreach ($ARRAYTOMADO as $r) : ?>
                                                                    ...
                                                                    <tr class="text-center">
                                                                        ...
                                                                        <form class="form-one-line" data-form-layout="oneline-4" style="display:flex;flex-wrap:wrap;align-items:flex-end;gap:0.65rem;padding:0.65rem 0;border-bottom:1px solid #3a3a3a;" method="post" id="form2">
