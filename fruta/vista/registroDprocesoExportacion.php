        ...
        <!- FUNCIONES BASES -!>
            <script type="text/javascript">
                ...
                function neto() {
                    ...
                    var repuesta;
                    var neto = 0;
                    var deshidratacion = 0;
                    var pesopallet;
                    var bruto = 0;
                    var peso_envase = 0;

                    ESTANDAR = document.getElementById("ESTANDAR").value;
                    document.getElementById('val_estandar').innerHTML = "";

                    if (ESTANDAR == null || ESTANDAR == "" || ESTANDAR == 0) {
                    ...
                    if (repuesta == 0) {
                        CANTIDADENVASE = parseFloat(document.getElementById("CANTIDADENVASE").value);
                        ...
                        CANTIDADENVASE = isNaN(CANTIDADENVASE) ? 0 : CANTIDADENVASE;
                        PESONETOEESTANDAR = isNaN(PESONETOEESTANDAR) ? 0 : PESONETOEESTANDAR;
                        PESOBRUTOEESTANDAR = isNaN(PESOBRUTOEESTANDAR) ? 0 : PESOBRUTOEESTANDAR;
                        PESOENVASEESTANDAR = isNaN(PESOENVASEESTANDAR) ? 0 : PESOENVASEESTANDAR;
                        PESOPALLETEESTANDAR = isNaN(PESOPALLETEESTANDAR) ? 0 : PESOPALLETEESTANDAR;
                        PDESHIDRATACIONEESTANDAR = isNaN(PDESHIDRATACIONEESTANDAR) ? 0 : PDESHIDRATACIONEESTANDAR;
                    ...
                    document.getElementById('KILOSNETOV').value = neto > 0 ? neto.toFixed(2) : '';
                    document.getElementById('KILOSNETODRECEPCION').value = neto > 0 ? neto.toFixed(2) : '';
                    document.getElementById('KILOSNETODPORENVASEV').value = peso_envase > 0 ? peso_envase.toFixed(2) : '';
                    document.getElementById('KILOSNETODPORENVASE').value = peso_envase > 0 ? peso_envase.toFixed(2) : '';

                    if (document.getElementById('KILOSNETOSDESHV')) {
                        document.getElementById('KILOSNETOSDESHV').value = deshidratacion > 0 ? deshidratacion.toFixed(2) : '';
                    }
                    if (document.getElementById('KILOSNETOSDESH')) {
                        document.getElementById('KILOSNETOSDESH').value = deshidratacion > 0 ? deshidratacion.toFixed(2) : '';
                    }
                    if (document.getElementById('KILOSBRUTOSREALESV')) {
                        document.getElementById('KILOSBRUTOSREALESV').value = bruto > 0 ? bruto.toFixed(2) : '';
                    }
                    if (document.getElementById('KILOSBRUTOSREALES')) {
                        document.getElementById('KILOSBRUTOSREALES').value = bruto > 0 ? bruto.toFixed(2) : '';
                    }
                }



                function recalcularCantidadEnvase() {
                    neto();
                    var kilosDeshInput = document.getElementById('KILOSNETOSDESHV');
                    if (kilosDeshInput) {
                        calcularKiloNeto();
                    }
                }
                ...
                function validacion() {
                    ...
                    neto();
                    var kilosDeshInput = document.getElementById('KILOSNETOSDESHV');
                    if (kilosDeshInput && kilosDeshInput.offsetParent !== null && kilosDeshInput.value !== '') {
                        calcularKiloNeto();
                    }
                ...
                document.addEventListener("DOMContentLoaded", function() {
                    ...
                    $(document).on("input keyup change blur", "#CANTIDADENVASE", function() {
                        recalcularCantidadEnvase();
                    });

                    var cantidadEnvaseInput = document.getElementById("CANTIDADENVASE");
                    if (cantidadEnvaseInput) {
                        ["input", "keyup", "change", "blur"].forEach(function(evento) {
                            cantidadEnvaseInput.addEventListener(evento, recalcularCantidadEnvase);
                        });

                        if (cantidadEnvaseInput.value !== "") {
                            recalcularCantidadEnvase();
                        }
                    }
                });
            ...
            <div class="content-wrapper">
                <div class="container-full">
                    ...
                    <section class="content">
                        <form data-form-layout="oneline-1" style="display:flex;flex-wrap:wrap;align-items:flex-end;gap:0.65rem;padding:0.65rem 0;border-bottom:1px solid #3a3a3a;" class="form form-one-line" role="form" method="post" name="form_reg_dato">
                            <div class="box">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xxl-2 col-xl-4 col-lg-4 col-md-4 col-sm-6 col-6 col-xs-6 ">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" placeholder="Cantidad Envase" oninput="recalcularCantidadEnvase()" onkeyup="recalcularCantidadEnvase()" onchange="recalcularCantidadEnvase()" onblur="recalcularCantidadEnvase()" id="CANTIDADENVASE" name="CANTIDADENVASE" value="<?php echo $CANTIDADENVASE; ?>" <?php echo $DISABLED; ?> <?php echo $DISABLEDSTYLE; ?> />
    ...
    <!- LLAMADA URL DE ARCHIVOS DE DISEÑO Y JQUERY E OTROS -!>
        ...
        <?php        
            ...
            if (isset($_REQUEST['CREAR'])) {
                $CANTIDADENVASEFORM = isset($_REQUEST['CANTIDADENVASE']) ? str_replace(',', '.', trim($_REQUEST['CANTIDADENVASE'])) : '';
                if ($CANTIDADENVASEFORM === '' || !is_numeric($CANTIDADENVASEFORM) || (float)$CANTIDADENVASEFORM <= 0) {
                    echo '<script>Swal.fire({icon:"warning",title:"Validación",text:"Cantidad Envase debe ser mayor a 0."});</script>';
                } else {
                ...
                if ($SINO == "0") {
                    ...
                    if ($ARRAYVERESTANDAR) {
                        ...
                        $EMBOLSADO = $ARRAYVERESTANDAR[0]['EMBOLSADO'];
                        $TEMBALAJE = $ARRAYVERESTANDAR[0]['ID_TEMBALAJE'];
                        $EMBOLSADOFORM = is_numeric($EMBOLSADO) ? (int)$EMBOLSADO : 0;
                        $TEMBALAJEFORM = is_numeric($TEMBALAJE) ? (int)$TEMBALAJE : 0;
                        $PESOPALLETEESTANDAR = $ARRAYVERESTANDAR[0]['PESO_PALLET_ESTANDAR'];
                        $PDESHIDRATACIONEESTANDAR = $ARRAYVERESTANDAR[0]['PDESHIDRATACION_ESTANDAR'];
                    ...
                    $DPEXPORTACION->__SET('EMBOLSADO', $EMBOLSADOFORM);
                    $DPEXPORTACION->__SET('ID_TEMBALAJE', $TEMBALAJEFORM);
                    ...
                    $EXIEXPORTACION->__SET('EMBOLSADO', $EMBOLSADOFORM);
                    $EXIEXPORTACION->__SET('ID_TEMBALAJE', $TEMBALAJEFORM);
...
function calcularKiloNeto() {
    var kilosNetosDeshInput = document.getElementById('KILOSNETOSDESHV');
    if (!kilosNetosDeshInput) {
        return;
    }

    var kilosNetosDeshRaw = kilosNetosDeshInput.value.replace(',', '.').trim();
    if (kilosNetosDeshRaw === '') {
        return;
    }

    // Obtener el valor de Kilos Netos Desh.
    var kilosNetosDesh = parseFloat(kilosNetosDeshRaw) || 0;
    ...
    document.getElementById('KILOSBRUTOSREALESV').value = kilosBrutos > 0 ? kilosBrutos.toFixed(2) : '';
    if (document.getElementById('KILOSBRUTOSREALES')) {
        document.getElementById('KILOSBRUTOSREALES').value = kilosBrutos > 0 ? kilosBrutos.toFixed(2) : '';
    }
    document.getElementById('KILOSNETOV').value = kiloNeto > 0 ? kiloNeto.toFixed(2) : '';
    document.getElementById('KILOSNETODRECEPCION').value = kiloNeto > 0 ? kiloNeto.toFixed(2) : '';
    if (document.getElementById('KILOSNETOSDESH')) {
        document.getElementById('KILOSNETOSDESH').value = kilosNetosDesh > 0 ? kilosNetosDesh.toFixed(2) : '';
    }
    ...
    if (kilosPorEnvaseInput) {
        kilosPorEnvaseInput.value = kilosPorEnvase > 0 ? kilosPorEnvase.toFixed(2) : '';
    }
    if (document.getElementById('KILOSNETODPORENVASE')) {
        document.getElementById('KILOSNETODPORENVASE').value = kilosPorEnvase > 0 ? kilosPorEnvase.toFixed(2) : '';
    }
}
</script>
</body>
