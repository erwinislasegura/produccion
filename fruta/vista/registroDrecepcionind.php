...
<head>
    ...
    <!- LLAMADA DE LOS ARCHIVOS NECESARIOS PARA DISEÑO Y FUNCIONES BASE DE LA VISTA -!>
        ...
        <style>
            ...
            .sistemRR .box { background:var(--card); border:1px solid var(--line); border-radius:8px; box-shadow:0 2px 8px rgba(15,23,42,.04); overflow:hidden; }
            ...
            .sistemRR .box-body { padding:8px; background:#fafbfd; counter-reset: detalle-section; }
            ...
            .sistemRR .compact-section-title::before { counter-increment:detalle-section; content:counter(detalle-section); display:inline-flex; align-items:center; justify-content:center; width:21px; height:21px; flex:0 0 21px; border-radius:50%; background:#eaf7ee; color:var(--primary-dark); font-size:12px; font-weight:700; }
            ...
            .sistemRR .form-group { margin-bottom:.24rem; }
            .sistemRR .form-group label { margin-bottom:3px; font-size:12px; font-weight:700; color:#374151; line-height:1.2; }
            .sistemRR .form-control, .sistemRR .select2-container--default .select2-selection--single { border-radius:4px !important; min-height:28px; height:28px; padding:3px 8px; font-size:13px; border:1px solid var(--input-border); background:#fff; box-shadow:none; }
            ...
            .sistemRR .select2-container .select2-selection--single .select2-selection__rendered { line-height:20px !important; padding-left:8px; padding-right:20px; font-size:13px; color:var(--text); }
            .sistemRR .select2-container .select2-selection--single .select2-selection__arrow { height:28px !important; }
            ...
            .sistemRR .box-footer { margin-top:5px; border-top:1px solid var(--line); padding:7px 10px; background:#fff; position:sticky; bottom:0; z-index:5; }
            .sistemRR .box-footer .btn-group { display:flex; flex-wrap:wrap; gap:6px; align-items:center; }
            .sistemRR .box-footer .btn-block { width:auto; }
                        ...
                        <form data-form-layout="oneline-1" style="display:flex;flex-wrap:wrap;align-items:flex-end;gap:0.65rem;padding:0.65rem 0;border-bottom:1px solid #3a3a3a;" class="form form-one-line" role="form" method="post" name="form_reg_dato" id="form_reg_dato">
                            <div class="box">
                                <div class="box-header with-border bg-success">                                   
                                    <h4 class="box-title">Registro Detalle Industrial</h4>
                                    <p class="box-subtitle">Complete la clasificación, pesos y envases del folio industrial.</p>
                                </div>
                                <div class="box-body ">
                                    <div class="vextra-section">
                                    <div class="compact-section-title"><span class="title-main">Identificación del folio</span><span class="title-sub">Folio, fecha, productor y estándar</span></div>
                                    <div class="row">
                                    ...
                                    <div class="vextra-section">
                                    <div class="compact-section-title"><span class="title-main">Clasificación</span><span class="title-sub">Gasificación, variedad y manejo</span></div>
                                    <div class="row">
                                        <div class="col-xxl-2 col-xl-4 col-lg-4 col-md-4 col-sm-6 col-6 col-xs-6 ">
                                            <div class="form-group">
                                    ...
                                    <div class="vextra-section">
                                    <div class="compact-section-title"><span class="title-main">Pesos y envases</span><span class="title-sub">Cálculo de kilos netos</span></div>
                                    <div class="row">
                                        <div class="col-xxl-2 col-xl-4 col-lg-4 col-md-4 col-sm-6 col-6 col-xs-6 ">
                                            <div class="form-group">
