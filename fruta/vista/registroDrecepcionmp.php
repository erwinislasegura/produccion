...
include_once '../../assest/controlador/RVESPECIES_ADO.php';
...
function obtenerVariedadesPorProductorEstandar($IDPRODUCTOR, $IDESTANDAR, $IDEMPRESA, $ERECEPCION_ADO, $VESPECIES_ADO, $RVESPECIES_ADO)
{
    if ($IDESTANDAR == "" || $IDESTANDAR == null) {
        return array();
    }

    $ARRAYVERESTANDAR = $ERECEPCION_ADO->verEstandar($IDESTANDAR);
    if (!$ARRAYVERESTANDAR) {
        return array();
    }

    $ARRAYVESPECIES = $VESPECIES_ADO->buscarVespeciesPorEspeciesPorEmpresaCBX($ARRAYVERESTANDAR[0]['ID_ESPECIES'], $IDEMPRESA);

    if ($IDPRODUCTOR == "" || $IDPRODUCTOR == null) {
        return array();
    }

    $ARRAYRVESPECIESPRODUCTOR = $RVESPECIES_ADO->buscarPorProductor($IDPRODUCTOR);
    if (!$ARRAYRVESPECIESPRODUCTOR) {
        return array();
    }

    $IDSVARIEDADES = array();
    foreach ($ARRAYRVESPECIESPRODUCTOR as $rv) {
        if (isset($rv['ID_VESPECIES'])) {
            $IDSVARIEDADES[] = (string)$rv['ID_VESPECIES'];
        }
    }

    if (count($IDSVARIEDADES) == 0) {
        return array();
    }

    $ARRAYFILTRADO = array();
    foreach ($ARRAYVESPECIES as $v) {
        if (in_array((string)$v['ID_VESPECIES'], $IDSVARIEDADES)) {
            $ARRAYFILTRADO[] = $v;
        }
    }
...
$RVESPECIES_ADO =  new RVESPECIES_ADO();
...
if ($id_dato !== "" && $accion_dato !== "" && $urlo_dato !== "" && $idd_dato !== "" && $acciond_dato !== "") {
    ...
    if ($OP == "crear") {
        ...
        foreach ($ARRAYDRECEPCION as $r) :
            ...
            $ARRAYVESPECIES = obtenerVariedadesPorProductorEstandar($PRODUCTOR, $ESTANDAR, $EMPRESAS, $ERECEPCION_ADO, $VESPECIES_ADO, $RVESPECIES_ADO);
...
<head>
    ...
    <!- LLAMADA DE LOS ARCHIVOS NECESARIOS PARA DISEÑO Y FUNCIONES BASE DE LA VISTA -!>
        ...
        <style>
            ...
            .sistemRR #form_reg_dato .box-body {
                padding: 8px;
                background: #fafbfd;
                counter-reset: detalle-section;
            }
            ...
            .sistemRR .compact-section-title::before {
                counter-increment: detalle-section;
                content: counter(detalle-section);
                display: inline-flex;
                align-items: center;
            ...
            .sistemRR #form_reg_dato .form-control,
            .sistemRR #form_reg_dato .select2-container--default .select2-selection--single,
            .sistemRR #form_reg_dato .select2-container--default .select2-selection--multiple {
            ...
            .sistemRR #form_reg_dato input[type="number"],
            .sistemRR #form_reg_dato input[type="text"],
            .sistemRR #form_reg_dato input[type="date"],
            .sistemRR #form_reg_dato input[type="time"] {
                text-align: left;
                padding-left: 10px !important;
                padding-right: 12px !important;
            }

            .sistemRR #form_reg_dato textarea.form-control {
            ...
            .sistemRR #form_reg_dato .form-control:focus,
            .sistemRR #form_reg_dato .select2-container--default.select2-container--focus .select2-selection--single {
                border-color: var(--input-focus);
                box-shadow: 0 0 0 3px rgba(59, 130, 246, .10);
            }

            .sistemRR #form_reg_dato .form-group {
                margin-bottom: .24rem;
            }

            .sistemRR #form_reg_dato label {
                margin-bottom: 3px;
                font-size: 12px;
                font-weight: 700;
                color: #374151;
            ...
            .sistemRR #form_reg_dato .select2-container .select2-selection--single .select2-selection__rendered {
            ...
            .sistemRR #form_reg_dato .select2-container .select2-selection--single .select2-selection__arrow {
                height: 28px !important;
            }

            .sistemRR #form_reg_dato .btn {
                border-radius: 4px !important;
                min-height: 36px;
                padding: 0 14px;
                font-size: 12px;
            ...
            .sistemRR #form_reg_dato .btn-primary {
                background: var(--primary);
                border-color: var(--primary);
            }

            .sistemRR #form_reg_dato .btn-primary:hover {
                background: var(--primary-dark);
                border-color: var(--primary-dark);
            }

            .sistemRR #form_reg_dato .box-footer {
                margin-top: 5px;
            ...
            .sistemRR #form_reg_dato .box-footer .btn-group {
                display: flex;
                flex-wrap: wrap;
                gap: 6px;
                align-items: center;
            ...
            .sistemRR #form_reg_dato .box-footer .btn-group .btn {
                margin: 0 !important;
            }

            .sistemRR #form_reg_dato .box-footer .btn-block {
                width: auto;
            }
            ...
            .sistemRR #form_reg_dato .form-control[disabled],
            .sistemRR #form_reg_dato .form-control:disabled {
                        ...
                        <div class="box">
                            ...
                            <form data-form-layout="oneline-1" style="display:flex;flex-wrap:wrap;align-items:flex-end;gap:0.65rem;padding:0.65rem 0;border-bottom:1px solid #3a3a3a;" class="form form-one-line" role="form" method="post" name="form_reg_dato" id="form_reg_dato" >
                                <div class="box-body form-element">
                                    ...
                                    <div class="compact-section-title"><span class="title-main">Identificación del folio</span><span class="title-sub">Folio, fecha y origen del productor</span></div>
                                    <div class="row">
                                        ...
                                        <div class="col-xxl-2 col-xl-4 col-lg-4 col-md-4 col-sm-6 col-6 col-xs-6 ">
                                            <div class="form-group">
                                                ...
                                                <?php if ($TRECEPCION == 1) { ?>
                                                 ...
                                                 <?php } ?>
                                                <?php if ($TRECEPCION == 2) { ?>
                                                    <select class=" form-control select2" id="PRODUCTOR" name="PRODUCTOR" style="width: 100%;" onchange="this.form.submit();" <?php echo $DISABLED; ?> <?php echo $DISABLEDSTYLE; ?>>
                                                    <option></option>
                                    ...
                                    <div class="vextra-section">
                                    <div class="compact-section-title"><span class="title-main">Clasificación y tratamientos</span><span class="title-sub">Variedad, manejo y tratamientos asociados</span></div>
                                    <div class="row">
                                    ...
                                    <div class="vextra-section">
                                    <div class="compact-section-title"><span class="title-main">Pesos y envases</span><span class="title-sub">Cálculo del neto y nota de la línea</span></div>
                                    <div class="row">
                                        <div class="col-xxl-2 col-xl-4 col-lg-4 col-md-4 col-sm-6 col-6 col-xs-6 ">
                                            <div class="form-group">
