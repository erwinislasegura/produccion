...
<head>
    ...
    <style>
        ...
        .sistemRR .content { background: var(--bg); padding-top: 8px; }
        .sistemRR .content-header { padding-bottom: 6px; }
        .sistemRR .form-one-line { display: block !important; padding: 0 !important; border-bottom: 0 !important; gap: 0 !important; }
        .sistemRR .box, .sistemRR .card, .sistemRR .modal-content { background: var(--card); border:1px solid var(--line); border-radius:8px; box-shadow:0 2px 8px rgba(15,23,42,.04); overflow:hidden; }
        .sistemRR .box-header { background:#fff !important; color:var(--text); padding:9px 14px; border-bottom:1px solid var(--line); border-top:3px solid var(--primary); }
        .sistemRR .box-header .box-title { margin:0; font-size:18px; font-weight:700; color:var(--text); }
        .sistemRR .box-header .box-subtitle { margin:3px 0 0; font-size:12px; color:var(--muted); }
        .sistemRR .box-body { padding:8px; background:#fafbfd; counter-reset: recepcion-section; }
        .sistemRR .vextra-section { background:var(--section-bg); border:1px solid rgba(40,167,69,.28); border-left:3px solid rgba(40,167,69,.72); border-radius:7px; padding:7px 9px 5px; margin-bottom:6px; box-shadow:0 1px 3px rgba(15,23,42,.035); }
        .sistemRR .vextra-section:hover { border-color:rgba(40,167,69,.42); border-left-color:rgba(40,167,69,.95); box-shadow:0 4px 12px rgba(15,23,42,.055); }
        .sistemRR .compact-section-title { display:flex; align-items:center; justify-content:space-between; gap:8px; margin:-7px -9px 6px; padding:7px 9px 6px; border-bottom:1px solid var(--line); border-radius:6px 6px 0 0; background:linear-gradient(90deg,#f8fbff 0%,#fff 72%); font-size:0; }
        .sistemRR .compact-section-title::before { counter-increment: recepcion-section; content:counter(recepcion-section); display:inline-flex; align-items:center; justify-content:center; width:21px; height:21px; flex:0 0 21px; border-radius:50%; background:#eaf7ee; color:var(--primary-dark); font-size:12px; font-weight:700; }
        .sistemRR .compact-section-title .title-main { font-size:15px; font-weight:700; color:#111827; margin-right:auto; }
        .sistemRR .compact-section-title .title-sub { font-size:12px; color:var(--muted); padding:2px 7px; border-radius:999px; background:#f1f5f9; white-space:nowrap; }
        .sistemRR .form-group { margin-bottom:.28rem; }
        .sistemRR .form-group label, .sistemRR .modal-body label { font-size:12px; font-weight:700; margin-bottom:3px; color:#374151; line-height:1.2; }
        .sistemRR .form-control, .sistemRR .select2-container--default .select2-selection--single { border:1px solid var(--input-border); border-radius:4px !important; min-height:29px; height:29px; padding:4px 8px; font-size:13px; box-shadow:none; }
        .sistemRR .form-control[disabled], .sistemRR .form-control:disabled { background:#f8fafc !important; color:#64748b; border-color:#e2e8f0; }
        .sistemRR input[type="number"], .sistemRR input[type="text"], .sistemRR input[type="date"], .sistemRR input[type="time"] { text-align:left; padding-left:10px !important; padding-right:12px !important; }
        .sistemRR textarea.form-control { min-height:40px; height:auto; resize:vertical; border-radius:4px !important; }
        .sistemRR .form-control:focus, .sistemRR .select2-container--default.select2-container--focus .select2-selection--single { border-color:var(--input-focus); box-shadow:0 0 0 3px rgba(59,130,246,.10); }
        .sistemRR .select2-container--default .select2-selection--single { display:flex; align-items:center; }
        .sistemRR .select2-container .select2-selection--single .select2-selection__rendered { line-height:20px; padding-left:8px; padding-right:20px; font-size:13px; color:var(--text); }
        .sistemRR .select2-container .select2-selection--single .select2-selection__arrow { height:29px; }
        .sistemRR .btn { border-radius:4px !important; min-height:36px; padding:0 14px; font-size:12px; font-weight:700; }
        .sistemRR .btn-primary { background:var(--primary); border-color:var(--primary); }
        .sistemRR .btn-primary:hover { background:var(--primary-dark); border-color:var(--primary-dark); }
        .sistemRR .btn-inline-add { margin-top:18px; }
        .sistemRR .btn-inline-add .btn { height:29px; min-width:29px; min-height:29px; padding:0; }
        .sistemRR .row { margin-left:-5px; margin-right:-5px; }
        .sistemRR [class*="col-"] { padding-left:5px; padding-right:5px; }
        .sistemRR .envase-hint { display:flex; align-items:center; gap:8px; margin:0 0 5px; color:#4b5563; font-size:13px; }
        .sistemRR .box-footer { display:flex; justify-content:space-between; flex-wrap:wrap; gap:10px; margin-top:6px; padding:8px 12px; border-top:1px solid var(--line); background:#fff; position:sticky; bottom:0; z-index:5; }
        .sistemRR .box-footer .btn-group { display:flex; flex-wrap:wrap; gap:6px; }
        .sistemRR .validacion { font-size:11px; color:#b91c1c; margin-top:2px; display:block; }
        .sistemRR .detalle-card { margin-top:8px; border:1px solid var(--line); border-radius:8px; box-shadow:0 2px 8px rgba(15,23,42,.04); overflow:hidden; }
        .sistemRR .detalle-card .card-header.bg-success { background:#fff !important; color:var(--text); padding:8px 12px; border-bottom:1px solid var(--line); border-top:3px solid var(--primary); }
        .sistemRR .detalle-acciones { display:flex; flex-wrap:nowrap; gap:6px; align-items:center; overflow-x:auto; }
        .sistemRR .detalle-acciones .btn { min-height:26px; height:26px; padding:0 8px; font-size:11px; font-weight:600; border-radius:6px !important; white-space:nowrap; line-height:1; box-shadow:none; }
        .sistemRR .detalle-acciones .btn i { font-size:11px; margin-right:3px; }
        .sistemRR .detalle-acciones .btn br { display:none; }
        .sistemRR .table-responsive { border:1px solid var(--line); border-radius:7px; background:#fff; }
        .sistemRR #detalle thead th { position:sticky; top:0; z-index:2; background:#f3f6f9; border-bottom:1px solid var(--line); white-space:nowrap; }
        .sistemRR #detalle th, .sistemRR #detalle td { padding:5px 7px; vertical-align:middle; }
    </style>
    <!- FUNCIONES BASES -!>
...
<body class="fruta-form-compact hold-transition light-skin fixed sidebar-mini theme-primary sistemRR"  >
    <div class="wrapper">
                    ...
                    <section class="content">
                        <form data-form-layout="oneline-1" style="display:flex;flex-wrap:wrap;align-items:flex-end;gap:0.65rem;padding:0.65rem 0;border-bottom:1px solid #3a3a3a;" class="form form-one-line" role="form" method="post" name="form_reg_dato" id="form_reg_dato">
                            <div class="box">
                                 <div class="box-header with-border bg-primary">                                   
                                    <h4 class="box-title">Registro de Recepción Industrial</h4>
                                    <p class="box-subtitle">Complete los datos principales, transporte, origen y envases.</p>
                                </div>
                                <div class="box-body ">
                                    <div class="vextra-section">
                                    <div class="compact-section-title"><span class="title-main">Datos del documento</span><span class="title-sub">Información general del registro</span></div>
                                    <div class="row">
                                    ...
                                    <div class="vextra-section">
                                    <div class="compact-section-title"><span class="title-main">Recepción y guía</span><span class="title-sub">Fecha, tipo y guía</span></div>
                                    <div class="row">
                                    ...
                                    <div class="vextra-section">
                                    <div class="compact-section-title"><span class="title-main">Transporte</span><span class="title-sub">Transportista, conductor y patentes</span></div>
                                    <div class="row">
                                        <div class="col-xxl-5 col-xl-5 col-lg-9 col-md-9 col-sm-9 col-9 col-xs-9">
                                            <div class="form-group">
                                    ...
                                    <div class="vextra-section">
                                    <div class="compact-section-title"><span class="title-main">Origen</span><span class="title-sub">Productor o planta origen</span></div>
                                    <div class="row">
                                        <?php if ($TRECEPCION == "") { ?>
                                            <div class="col-xxl-2 col-xl-4 col-lg-6 col-md-6 col-sm-6 col-6 col-xs-6">
                                                <div class="form-group">
                                    ...
                                    <div class="vextra-section">
                                    <div class="compact-section-title"><span class="title-main">Observaciones</span><span class="title-sub">Notas del registro</span></div>
                                    <div class="row">
                                    ...
                                    <div class="vextra-section">
                                    <div class="compact-section-title"><span class="title-main">Recepción de envases</span><span class="title-sub">Documento asociado</span></div>
                                    <div class="envase-hint"><i class="fas fa-info-circle"></i><span>Datos necesarios para la recepción de envases</span></div>
                                    <div class="row">
                                        <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-12 col-sm-12 col-12 col-xs-12">
                                            <div class="form-group">
                        ...
                        <div class="modal fade" id="modalAgregarTransporte" tabindex="-1" role="dialog" aria-labelledby="modalAgregarTransporteLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <form class="form-one-line" data-form-layout="oneline-2" style="display:flex;flex-wrap:wrap;align-items:flex-end;gap:0.65rem;padding:0.65rem 0;border-bottom:1px solid #3a3a3a;" method="post" id="formModalTransporte">
                        ...
                        <div class="modal fade" id="modalAgregarConductor" tabindex="-1" role="dialog" aria-labelledby="modalAgregarConductorLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <form class="form-one-line" data-form-layout="oneline-3" style="display:flex;flex-wrap:wrap;align-items:flex-end;gap:0.65rem;padding:0.65rem 0;border-bottom:1px solid #3a3a3a;" method="post" id="formModalConductor">
                                    <input type="hidden" name="AJAX_MODAL" value="1" />
                            ...
                            <div class="card detalle-card">
                                ...
                                <div class="card-header">
                                    <div class="form-row align-items-center">
                                        <form class="form-one-line" data-form-layout="oneline-4" style="display:flex;flex-wrap:wrap;align-items:flex-end;gap:0.65rem;padding:0.65rem 0;border-bottom:1px solid #3a3a3a;" method="post" id="form2" name="form2">
                                                ...
                                                <?php if ($ARRAYDRECEPCION) { ?>
                                                    <?php foreach ($ARRAYDRECEPCION as $s) : ?>
                                                        ...
                                                        <tr class="text-lef">
                                                            ...
                                                            <td>
                                                                <form class="form-one-line" data-form-layout="oneline-5" style="display:flex;flex-wrap:wrap;align-items:flex-end;gap:0.65rem;padding:0.65rem 0;border-bottom:1px solid #3a3a3a;" method="post" id="form1">
                                                                    ...
                                                                    <div class="btn-group btn-rounded btn-block detalle-acciones" role="group" aria-label="Operaciones Detalle">
                                                                        <?php if ($ESTADO == "0") { ?>
