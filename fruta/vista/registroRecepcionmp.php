...
<head>
    ...
    <style>
        ...
        .sistemRR .content-header {
            padding-bottom: 6px;
        }

        .sistemRR .form-one-line {
        ...
        .sistemRR .box-header .box-subtitle {
            margin: 3px 0 0;
            font-size: 12px;
            color: var(--muted);
        }
        ...
        .sistemRR .compact-section-title {
            display: flex;
            align-items: center;
        ...
        .sistemRR input[type="number"],
        .sistemRR input[type="text"],
        .sistemRR input[type="date"],
        .sistemRR input[type="time"] {
            text-align: left;
        ...
        .sistemRR .form-control:focus,
        .sistemRR .select2-container--default.select2-container--focus .select2-selection--single {
        ...
        .sistemRR .btn-inline-add {
            margin-top: 18px;
        }

        .sistemRR .btn-inline-add .btn,
        .sistemRR .btn-icon {
            height: 29px;
            min-width: 29px;
            border: none;
        ...
        .sistemRR .btn-inline-add .btn:hover {
            background: #16a34a;
        }

        .sistemRR .envase-hint {
            display: flex;
            align-items: center;
            gap: 8px;
            padding-top: 0;
        ...
        .sistemRR .btn-warning {
            background: #eef2f7;
            color: #374151;
            border: 1px solid #dbe2e8;
        }

        .sistemRR .btn-primary {
            background: var(--primary);
            color: #fff;
            border: none;
            box-shadow: 0 3px 10px rgba(31, 79, 130, .18);
        }

        .sistemRR .btn-success,
        .sistemRR .btn-info,
        .sistemRR .btn-danger {
            border: none;
        }

        .sistemRR .detalle-card {
            border: 1px solid var(--line);
            border-radius: 8px;
            box-shadow: 0 2px 8px rgba(15, 23, 42, 0.04);
            overflow: hidden;
        ...
        .sistemRR .detalle-card .card-header.bg-success {
            background: #fff !important;
            color: var(--text);
            padding: 8px 12px;
            border-bottom: 1px solid var(--line);
        ...
        .sistemRR .detalle-card .card-header.bg-success .card-title {
            margin: 0;
            font-size: 16px;
            font-weight: 700;
        }
        ...
        .sistemRR #CREARDURL,
        .sistemRR .detalle-acciones .btn {
            border-radius: 4px !important;
        }

        .sistemRR .detalle-acciones {
            display: flex;
            flex-wrap: nowrap;
            gap: 6px;
            align-items: center;
        ...
        .sistemRR .btn-rounded.btn-group .btn,
        .sistemRR .btn-rounded .btn {
            border-radius: 4px !important;
        }
        ...
        .sistemRR .detalle-acciones .btn i {
            font-size: 11px;
            margin-right: 3px;
        }

        .sistemRR .detalle-acciones .btn-info {
            background: #e8f3ff;
            border: 1px solid #cfe4fb;
            color: #1f4f82;
        }

        .sistemRR .detalle-acciones .btn-warning {
            background: #fff7e6;
            border: 1px solid #fde7bb;
            color: #9a6700;
        }

        .sistemRR .detalle-acciones .btn-secondary {
            background: #f3f4f6;
            border: 1px solid #e5e7eb;
            color: #374151;
        }

        .sistemRR .detalle-acciones .btn-danger {
            background: #feeceb;
            border: 1px solid #fecaca;
            color: #b91c1c;
        }

        .sistemRR .detalle-acciones .btn-primary {
            background: #eaf7ee;
        ...
        .sistemRR .input-group-prepend .input-group-text {
            border: 0;
            background: #f3f6f9;
            color: #374151;
            font-size: 12px;
        ...
        .sistemRR .input-group .form-control {
            border: 0;
            background: #fff;
            min-width: 92px;
        }

        .sistemRR .detalle-card .card-header:not(.bg-success) {
            background: #fbfdff;
            padding: 10px 12px 4px;
        }

        .sistemRR .detalle-card .form-row {
            gap: 6px 0;
        }

        .sistemRR .detalle-card .alert {
            margin: 10px 12px 0;
            padding: 8px 12px;
            border-radius: 6px;
        }

        .sistemRR .table-responsive {
            border: 1px solid var(--line);
            border-radius: 7px;
            background: #fff;
        }

        .sistemRR #detalle thead th {
            position: sticky;
            top: 0;
            z-index: 2;
            background: #f3f6f9;
        ...
        .sistemRR .vextra-section {
            border-left: 3px solid rgba(40, 167, 69, .72);
            box-shadow: 0 1px 3px rgba(15, 23, 42, .035);
        }

        .sistemRR .vextra-section:hover {
        ...
        .sistemRR .form-control[disabled],
        .sistemRR .form-control:disabled {
                    ...
                    <section class="content">
                        ...
                        <form data-form-layout="oneline-1" style="display:flex;flex-wrap:wrap;align-items:flex-end;gap:0.65rem;padding:0.65rem 0;border-bottom:1px solid #3a3a3a;" class="form form-one-line" role="form" method="post" name="form_reg_dato" id="form_reg_dato">
                            <div class="box">                               
                                ...
                                <div class="box-body ">
                                    ...
                                    <div class="vextra-section">
                                    <div class="compact-section-title"><span class="title-main">Recepción y guía</span><span class="title-sub">Fecha, tipo y datos del documento de traslado</span></div>
                                    <div class="row">
                                        <div class="col-xxl-2 col-xl-4 col-lg-6 col-md-6 col-sm-6 col-6 col-xs-6">
                                            <div class="form-group">
                                                <label class="required-label">Fecha Recepción</label>
                                        ...
                                        <div class="col-xxl-2 col-xl-4 col-lg-6 col-md-6 col-sm-6 col-6 col-xs-6">
                                            <div class="form-group">
                                                <label class="required-label">Hora </label>
                                        ...
                                        <div class="col-xxl-2 col-xl-4 col-lg-6 col-md-12 col-sm-12 col-12 col-xs-12">
                                            <div class="form-group">
                                                <label class="required-label">Tipo Recepción</label>
                                        ...
                                        <div class="col-xxl-2 col-xl-4 col-lg-6 col-md-6 col-sm-6 col-6 col-xs-6">
                                            <div class="form-group">
                                                <label class="required-label">Número Guía</label>
                                        ...
                                        <div class="col-xxl-2 col-xl-4 col-lg-6 col-md-6 col-sm-6 col-6 col-xs-6">
                                            <div class="form-group">
                                                <label class="required-label">Fecha Guía</label>
                                        ...
                                        <div class="col-xxl-2 col-xl-4 col-lg-6 col-md-6 col-sm-6 col-6 col-xs-6">
                                            <div class="form-group">
                                                <label class="required-label">Total Envases Guia</label>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xxl-5 col-xl-5 col-lg-9 col-md-9 col-sm-9 col-9 col-xs-9">
                                            <div class="form-group">
                                                <label class="required-label">Conductor</label>
                                        ...
                                        <div class="col-xxl-2 col-xl-4 col-lg-6 col-md-6 col-sm-6 col-6 col-xs-6">
                                            <div class="form-group">
                                                <label class="required-label">Patente Camión</label>
                                        ...
                                        <div class="col-xxl-2 col-xl-4 col-lg-6 col-md-6 col-sm-6 col-6 col-xs-6">
                                            <div class="form-group">
                                                ...
                                                <span class="field-hint">Opcional si no aplica.</span>
                                    ...
                                    <div class="vextra-section">
                                    <div class="compact-section-title"><span class="title-main">Origen y observaciones</span><span class="title-sub">Productor, planta origen, CSG/CSP y notas</span></div>
                                    <div class="row">
                                        <?php if ($TRECEPCION == "") { ?>
                                            <div class="col-xxl-2 col-xl-4 col-lg-6 col-md-6 col-sm-6 col-6 col-xs-6">
                                                <div class="form-group">
                                            ...
                                            <div class="col-xxl-10 col-xl-8 col-lg-6 col-md-12 col-sm-12 col-12 col-xs-12">
                                                <div class="form-group">
                                                    <label>Observaciones</label>
                                                    <span class="field-hint">Use notas breves y operativas.</span>
                                        ...
                                        <?php if ($TRECEPCION == "1") { ?>
                                            ...
                                            <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 col-xs-12" id="mercados-productor-wrap" style="display:none;">
                                    ...
                                    <div class="vextra-section">
                                    <div class="compact-section-title"><span class="title-main">Recepción de envases</span><span class="title-sub">Documento asociado a envases</span></div>
                                    <div class="envase-hint"><input type="checkbox" id="datos_envases_hint" disabled><label for="datos_envases_hint" style="margin:0;font-weight:500;">Datos necesarios para la recepción de envases</label></div>
                                    <div class="row">
                                        <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-12 col-sm-12 col-12 col-xs-12">
                                            <div class="form-group">
                                                <label class="required-label">Tipo Documento</label>
                        ...
                        <div class="modal fade" id="modalAgregarTransporte" tabindex="-1" role="dialog" aria-labelledby="modalAgregarTransporteLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <form class="form-one-line" data-form-layout="oneline-2" style="display:flex;flex-wrap:wrap;align-items:flex-end;gap:0.65rem;padding:0.65rem 0;border-bottom:1px solid #3a3a3a;" method="post" role="form" id="formModalTransporte">
                        ...
                        <div class="modal fade" id="modalAgregarConductor" tabindex="-1" role="dialog" aria-labelledby="modalAgregarConductorLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <form class="form-one-line" data-form-layout="oneline-3" style="display:flex;flex-wrap:wrap;align-items:flex-end;gap:0.65rem;padding:0.65rem 0;border-bottom:1px solid #3a3a3a;" method="post" role="form" id="formModalConductor">
                                    <div class="modal-content">
                                        <div class="modal-header bg-success">
