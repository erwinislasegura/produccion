...
<head>
    ...
    <!- LLAMADA DE LOS ARCHIVOS NECESARIOS PARA DISEÑO Y FUNCIONES BASE DE LA VISTA -!>
        ...
        <style>
            /* Replica estilo visual de reembalaje para botones del formulario */
            #form_reg_dato .btn {
                        ...
                        <form data-form-layout="oneline-1" style="display:flex;flex-wrap:wrap;align-items:flex-end;gap:0.65rem;padding:0.65rem 0;border-bottom:1px solid #3a3a3a;" class="form form-one-line" role="form" method="post" name="form_reg_dato" id="form_reg_dato">
                            <div class="box">                             
                                ...
                                <div class="box-body ">
                                    ...
                                    <div class="row">                                        
                                        <div class="col-xxl-2 col-xl-2 col-lg-2 col-md-3 col-sm-3 col-4 col-xs-4">
                                            <div class="form-group">
                                                <label class="text-nowrap">Con Inspeccion</label>
                                        ...
                                        <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-9 col-sm-9 col-8 col-xs-8">
                                            <label>Motivo</label>
                                ...
                                <div class="box-footer">
                                    <div class="btn-toolbar justify-content-between acciones-repaletizaje" role="toolbar" aria-label="Toolbar">
                                        <div class="acciones-repaletizaje-grupo col-xxl-4 col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 col-xs-12" role="group" aria-label="Acciones generales">
                                            <?php if ($OP == "") { ?>
                                        ...
                                        <div class="acciones-repaletizaje-grupo justify-content-end col-xxl-4 col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 col-xs-12 float-right">
                                            <?php if ($OP != "") : ?>
                            ...
                            <div class="card">
                                ...
                                <div class="card-header">
                                    <form class="form-one-line" data-form-layout="oneline-2" style="display:flex;flex-wrap:wrap;align-items:flex-end;gap:0.65rem;padding:0.65rem 0;border-bottom:1px solid #3a3a3a;" method="post" id="form2" name="form2">
                                        <div class="form-row align-items-center resumen-totales-pill">
                                                    ...
                                                    <tbody>
                                                        <?php if ($ARRAYDREPALETIZAJE) { ?>
                                                            ...
                                                            ?>
                                                                    ...
                                                                    <td class="text-center">
                                                                        <form class="form-one-line" data-form-layout="oneline-5" style="display:flex;flex-wrap:wrap;align-items:flex-end;gap:0.65rem;padding:0.65rem 0;border-bottom:1px solid #3a3a3a;" method="post" id="form3">
