...
<head>
    <meta charset="UTF-8">
    <title>Acceso Material - SmartBerry ONE</title>
...
<main class="page">
    <section class="left-panel">
        <div class="left-content">
            <header class="brand">
                ...
                <h1 class="title">Acceso a gestión de materiales SmartBerry ONE</h1>
                <p class="subtitle">Ingresa para administrar materiales, envases y continuidad operacional.</p>
            ...
            <section class="login-card">
                ...
                <form method="post" id="loginForm" autocomplete="on">
                    ...
                    <div class="form-grid">
                        ...
                        <div class="option-box"><input type="checkbox" id="PRECARGA_EXPORTACION_MATERIAL"><label for="PRECARGA_EXPORTACION_MATERIAL">Cargar información pesada en segundo plano.</label></div>
                        <div class="security-note"><span class="material-icons-round">lock</span>Acceso privado para usuarios autorizados</div>
                        <div class="btn-row single"><a href="../../" class="btn btn-back">Volver</a><button type="submit" class="btn btn-login" name="ENTRAR">Entrar</button></div>
                    </div>
                </form>
            </section>
            <div class="footer-text">SmartBerry ONE · Portal privado de materiales.</div>
        </div>
    </section>
    <section class="right-panel">
        ...
        <div class="right-info"><div class="right-kicker"><span class="material-icons-round">inventory_2</span>Gestión de materiales</div><h2>Materiales ordenados para la operación</h2><p>Controla inventarios, movimientos y datos internos con una experiencia consistente.</p><div class="right-tags"><div class="right-tag"><span class="material-icons-round">eco</span>Producción</div><div class="right-tag"><span class="material-icons-round">qr_code_scanner</span>Trazabilidad</div><div class="right-tag"><span class="material-icons-round">shield</span>Control</div></div></div>
    </section>
</main>
<script>
    ...
    if (loginForm) { loginForm.addEventListener('submit', () => { const precarga = document.getElementById('PRECARGA_EXPORTACION_MATERIAL')?.checked; if (precarga) { localStorage.setItem('prefetch_despachoex_exportacion', '1'); } else { localStorage.removeItem('prefetch_despachoex_exportacion'); } }); }
</script>
<?php
